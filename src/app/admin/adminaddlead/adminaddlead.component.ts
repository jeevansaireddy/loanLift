...
@Component({
  ...
  styleUrl: './adminaddlead.component.scss'
})
export class AdminaddleadComponent {
  ...
  { section: 'Documents', id: 'form-16', label: 'Form 16', type: 'file', controlName: 'form16', errorMessage: 'Form 16 is required.' },
      ...
      // { section: 'Other', id: 'partner-name', label: 'Partner Name', type: 'text', inputType: 'text', controlName: 'partnerName', placeholder: 'Enter name of Partner', errorMessage: 'Partner name is required.' }
    ];
