...
// Import your lead service to fetch/edit leads.
...
{ section: 'Documents', id: 'form-16', label: 'Form 16', type: 'file', controlName: 'form16', errorMessage: 'Form 16 is required.' },
  ...
  constructor(private fb: FormBuilder, public router: Router, public leadser: LeadserviceService, private route: ActivatedRoute, public pincodeService: PincodeService) {
      ...
      this.leadser.getLoanApplication(this.itemId).subscribe(
        (response: any) => {apiResponse = response.applications_data;
          ...
          this.leadForm.patchValue({
            ...
            flatNo: apiResponse.flat_no,
            blockNo: apiResponse.block_no,
          });
        ...
        (error) => {
          console.error('Error fetching partner loan application:', error);
        }
      );
