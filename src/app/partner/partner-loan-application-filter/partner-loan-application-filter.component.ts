...
import { LoanApplication } from '../partnerdashboard/partnerdashboard.component';


@Component({
  selector: 'app-partner-loan-application-filter',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './partner-loan-application-filter.component.html',
  styleUrl: './partner-loan-application-filter.component.scss'
})
export class PartnerLoanApplicationFilterComponent {
